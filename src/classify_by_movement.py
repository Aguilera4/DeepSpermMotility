...
def classification_2_classes(sperm):
    ...
    if sperm['vcl'] >= 25 and sperm['str'] >= 0.4:
...
def classification_4_classes_v4(sperm):
    ...
    '''# Classify based on thresholds
    if sperm['vcl'] >= 25  and sperm['vsl'] >= 20  and sperm['lin'] >= 0.5 and sperm['str'] >= 0.8:
        return 0  # Rapdly progressive
    elif sperm['lin'] < 0.3 and sperm['str'] < 0.6:
        return 1 # Slowly progressive
    elif sperm['vcl'] >= 5 and (sperm['vsl'] < 10 or sperm['str'] < 0.5):
        return 2 # Non progressive
    elif sperm['vcl'] < 5:
        return 3  # Inmotile
    else:
    ...
    # Classify based on thresholds
    if sperm['vcl'] < 5:
        return 3  # Rapdly progressive
    elif sperm['vsl'] < 10 and sperm['str'] < 0.5:
        return 2 # Slowly progressive
    elif sperm['lin'] < 30:
        return 1 # Non progressive
    else:
        return 0