...
def draw_class_distribution(df):
    ...
    plt.xlabel("Label (0=Linear mean swim, 1=Circular swim, 2=Hyperactivated, 3=Inmotile)", fontsize=14)
    plt.ylabel("Count", fontsize=14)
    plt.xticks([0, 1, 2, 3], ['Linear mean swim', 'Circular swim', 'Hyperactivated', 'Inmotile'])  # Replace 0 and 1 with meaningful labels
    plt.show()
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('../results/data_features_labelling_preprocessing/dataset_extended_4c_15s_preprocessing_v2.csv')
